...
"""
image size needs to be divisible by 16 since downsampling 4 times
...
class UNet(nn.Module):
    def __init__(self, in_channels=3, n_classes=1, depth=5, wf=6, padding=True, batch_norm=False, up_mode='upconv'):
